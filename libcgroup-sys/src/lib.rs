...
extern "C" {
    ...
    pub fn cgroup_read_value_begin(controller: *const c_char,
                                   ...
                                   max: c_int)
                                   -> c_int;
    pub fn cgroup_read_value_next(handle: *const *const c_void,
                                  buffer: *mut c_char,
                                  max: c_int)
                                  -> c_int;
    pub fn cgroup_read_value_end(handle: *const *const c_void) -> c_int;

    pub fn cgroup_read_stats_begin(controller: *const c_char,
                                   path: *const c_char,
                                   handle: *const *const c_void,
    ...
    pub fn cgroup_get_task_begin(cgroup: *const c_char,
    ...
    pub fn cgroup_get_controller_begin(handle: *const *const c_void,
                                       info: *mut cgroup_mount_point)
                                       -> c_int;
    pub fn cgroup_get_controller_next(handle: *const *const c_void,
                                      info: *mut cgroup_mount_point)
                                      -> c_int;
    pub fn cgroup_get_controller_end(handle: *const *const c_void) -> c_int;

    pub fn cgroup_get_all_controller_begin(handle: *const *const c_void,
                                           info: *mut controller_data)
                                           -> c_int;
    pub fn cgroup_get_all_controller_next(handle: *const *const c_void,
                                          info: *mut controller_data)
                                          -> c_int;
    pub fn cgroup_get_all_controller_end(handle: *const *const c_void) -> c_int;


    pub fn cgroup_get_subsys_mount_point_begin(controller: *const c_char,
                                               handle: *const *const c_void,
                                               path: *mut c_char);
    ...
    pub fn cgroup_compare_controllers(cgca: *const cgroup_controller,
                                      cgcb: *const cgroup_controller)
                                      -> c_int;
    pub fn cgroup_set_uid_gid(cgroup: *const cgroup,
                              tasks_uid: uid_t,
                              tasks_gid: gid_t,
                              control_uid: uid_t,
                              control_gid: gid_t)
                              -> c_int;
    pub fn cgroup_get_uid_gid(cgroup: *const cgroup,
                              tasks_uid: *mut uid_t,
                              tasks_gid: *mut gid_t,
                              control_uid: *mut uid_t,
                              control_gid: *mut gid_t)
                              -> c_int;
    pub fn cgroup_set_permissions(cgroup: *const cgroup,
                                  control_dperm: mode_t,
                                  control_fperm: mode_t,
                                  task_fperm: mode_t);
    pub fn cgroup_add_value_string(controller: *const cgroup_controller,
                                   name: *const c_char,
                                   value: *const c_char)
                                   -> c_int;
    pub fn cgroup_add_value_int64(controller: *const cgroup_controller,
                                  name: *const c_char,
                                  value: int64_t)
                                  -> c_int;
    pub fn cgroup_add_value_uint64(controller: *const cgroup_controller,
                                   name: *const c_char,
                                   value: uint64_t)
                                   -> c_int;
    pub fn cgroup_add_value_bool(controller: *const cgroup_controller,
                                 name: *const c_char,
                                 value: bool)
                                 -> c_int;
    pub fn cgroup_get_value_string(controller: *const cgroup_controller,
                                   name: *const c_char,
                                   value: *const *const c_char)
                                   -> c_int;
    pub fn cgroup_get_value_int64(controller: *const cgroup_controller,
                                  name: *const c_char,
                                  value: *const int64_t)
                                  -> c_int;
    pub fn cgroup_get_value_uint64(controller: *const cgroup_controller,
                                   name: *const c_char,
                                   value: *const uint64_t)
                                   -> c_int;
    pub fn cgroup_get_value_bool(controller: *const cgroup_controller,
                                 name: *const c_char,
                                 value: *const bool)
                                 -> c_int;
    pub fn cgroup_set_value_string(controller: *const cgroup_controller,
                                   name: *const c_char,
                                   value: *const c_char)
                                   -> c_int;
    pub fn cgroup_set_value_int64(controller: *const cgroup_controller,
                                  name: *const c_char,
                                  value: int64_t)
                                  -> c_int;
    pub fn cgroup_set_value_uint64(controller: *const cgroup_controller,
                                   name: *const c_char,
                                   value: uint64_t)
                                   -> c_int;
    pub fn cgroup_set_value_bool(controller: *const cgroup_controller,
                                 name: *const c_char,
                                 value: bool)
                                 -> c_int;
    pub fn cgroup_get_value_name_count(controller: *const cgroup_controller) -> c_int;
    pub fn cgroup_get_value_name(controller: *const cgroup_controller,
                                 index: c_int)
                                 -> *const c_char;
    pub fn cgroup_get_procs(name: *const c_char,
                            controller: *const c_char,
                            pids: *const *const pid_t,
                            size: *mut c_int)
                            -> c_int;
    pub fn cg_chmod_recursive(cgroup: *const cgroup,
                              dir_mode: mode_t,
                              dirm_change: c_int,
                              file_mode: mode_t,
                              filem_change: c_int)
    ...
    pub fn cgroup_config_create_template_group(cgroup: *mut cgroup,
